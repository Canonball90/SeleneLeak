...
public class Management
    ...
    public Setting<String> command = this.register(new Setting<String>("Command", "Selene.es"));
    ...
    public Management() {
        super("Management", "Client Management.", Module.Category.CLIENT, false, false, true);
        this.setInstance();
    }
    ...
    @Override
    public void onLoad() {
        SeleneLoader.commandManager.setClientMessage(this.getCommandMessage());
    }
        ...
        if (event.getStage() == 2) {
            ...
            if (event.getSetting() != null && this.equals(event.getSetting().getFeature())) {
                if (event.getSetting().equals(this.holeThread)) {
                    SeleneLoader.holeManager.settingChanged();
                }
                SeleneLoader.commandManager.setClientMessage(this.getCommandMessage());
            }
        }
