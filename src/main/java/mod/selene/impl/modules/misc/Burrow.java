...
public class Burrow extends Module {
    ...
    public Setting<Float> maxDown = register(new Setting("Max-Down", Float.valueOf(10.0F), Float.valueOf(0.0F), Float.valueOf(1337.0F)));
    ...
    public Burrow() {
        super("Burrow", "Puts you in a block.", Category.MISC, false, false, true);
    }
    ...
    public void onUpdate() {
        ...
        int slot = anvil.getValue()
                ? InventoryUtil.findHotbarBlock(BlockAnvil.class)
                : beacon.getValue()
                ? InventoryUtil.findHotbarBlock(BlockBeacon.class)
                : (echest.getValue()
                || mc.world.getBlockState(pos.down())
                .getBlock() == Blocks.ENDER_CHEST
                ? InventoryUtil.findHotbarBlock(BlockEnderChest.class)
